...
public class TimeStampComparatorTest {
	...
	private void befor() {
		...
		ApfsElement home = new ApfsDirectory(root, "Home", 0, LocalDateTime.of(2019, 2, 2, 13, 0), "Owais", null);
		root.appendChild(home);
		
		ApfsElement picture = new ApfsDirectory(home, "Picture", 0, LocalDateTime.of(2019, 3, 2, 12, 0), "Owais", null);
